    ...
    <div class="container mx-auto px-4 py-6">
      ...
      <div class="flex items-center justify-between mb-8">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h1
              class="text-3xl font-bold bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent"
            >
              AI 助手設定
            </h1>
            <p class="text-gray-400 text-sm mt-1">設定 AI 模型和個人化參數</p>
          </div>
        </div>
        ...
        <div class="flex items-center gap-3">
          ...
          <button
            @click="goHome"
            class="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 rounded-lg hover:shadow-lg hover:shadow-purple-500/30 transition-all duration-200 flex items-center gap-2 active:scale-95"
          >
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                stroke-linecap="round"
      ...
      <div class="max-w-2xl mx-auto">
        <div class="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 shadow-2xl">
          <div class="p-8 space-y-8">
            ...
            <div class="space-y-4">
              <div class="flex items-center justify-between">
                <label class="text-lg font-semibold text-gray-200">OpenRouter API Key</label>
                <a
              ...
              <div class="relative">
                <input
                  ...
                  class="w-full bg-gray-700/50 border border-gray-600 rounded-lg px-4 py-3 pr-12 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                  @input="clearError"
                />
                <button
            ...
            <div v-if="aiConfig.isConfigured" class="space-y-4">
              <label class="text-lg font-semibold text-gray-200">選擇 AI 模型</label>
              <select
                v-model="aiConfig.selectedModel"
                @change="aiConfig.saveToStorage()"
                class="w-full bg-gray-700/50 border border-gray-600 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
              >
                <option
            ...
            <div v-if="aiConfig.isConfigured" class="space-y-6">
              <!-- 進階設定標題 -->
              <div class="flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-200">進階設定</h3>
                <button
                  @click="showAdvanced = !showAdvanced"
                  class="text-blue-400 hover:text-blue-300 transition-colors flex items-center gap-2 text-sm"
                >
                  <svg
              ...
              <div v-if="showAdvanced" class="space-y-6 pt-4 border-t border-gray-700">
                ...
                <div class="space-y-3">
                  ...
                  <p class="text-sm text-gray-500">較低的值產生更一致的回應，較高的值更具創造性</p>
                </div>
                ...
                <!-- 系統提示 -->
                <div class="space-y-3">
                  <label class="text-base font-medium text-gray-300">系統提示</label>
                  <textarea
          ...
          <!-- 底部按鈕區 -->
          <div class="flex gap-4 p-8 border-t border-gray-700 bg-gray-800/30">
            <button
              v-if="aiConfig.isConfigured"
              @click="resetSettings"
              class="flex-1 bg-red-600/20 hover:bg-red-600/30 text-red-400 px-6 py-3 rounded-lg transition-all font-medium"
            >
              重置設定
            </button>
            <button
              ...
              :class="[
                'flex-1 px-6 py-3 rounded-lg transition-all font-medium',
        ...
        <!-- 使用說明 -->
        <div class="mt-8 bg-blue-500/10 border border-blue-500/30 rounded-lg p-6">
